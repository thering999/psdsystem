...
<html lang="en">
    <head>
        ...
        <title>ระบบยืม-คืนครุภัณฑ์ สสจ.มุกดาหาร</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Login<br>ระบบยืม-คืนครุภัณฑ์ สสจ.มุกดาหาร</h3></div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer text-center">
                                        <div class="small">ระบบยืม-คืนครุภัณฑ์ สสจ.มุกดาหาร</div>
                                    </div>
                                </div>
                            </div>
                        </div>
