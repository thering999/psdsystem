...
?>   
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">รายชื่อผู้ใช้งาน<a href="index.php?view=add" class="btn btn-primary btn-sm" ><i class="fa fa-plus"></i>เพิ่มใหม่</a></h6>
            </div>
            <div class="card-body">
