...
?> 
 ...
 <div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">แก้ไขรายละเอียดผู้ใช้งาน</h6>
  </div>
  <div class="card-body">
...
<!-- 
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "user_type">ประเภทผู้ใช้งาน:</label>
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="user_type" id="user_type">
                          ...
                          <option <?php echo ($singleuser->TYPE=='Librarian')? 'SELECTED':'';?>>User</option>  
                        </select> 
                      </div>
                    </div>
                  </div>
             ...
             <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <button class="btn btn-primary" id="usersave" name="save" type="submit" ><i class="fa fa-save"></i>บันทึก</button>
                          <a href="index.php" class="btn btn-info"><span class="fa fa-arrow-left"></span>รายชื่อผู้ใช้งาน</a>
                      </div>
                    </div>
                  </div>
