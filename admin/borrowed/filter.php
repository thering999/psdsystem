		  ...
		  <form class="form-horizontal span4" action="#.php" method="POST" autocomplete="off">
					...
					<div class="panel panel-primary">
					  <div class="panel-heading">
					    <h3 class="panel-title"><span class="glyphicon glyphicon-filter"></span>ค้นหา ครุภัณฑ์</h3>
					    <hr/>
					  </div>
						...
						<div class="form-group" id="subjcode">
				            <div class="row">
				               <label class="col-md-2 control-label"></label>
				                ...
				                <div class="col-md-10">
							         <div class="btn-group">
									    <button type="submit" name="search" class="btn btn-primary"><i class="fa fa-search"></i>ค้นหา</button>
									    <button type="Reset" name="search" class="btn btn-info"><i class="fa fa-refresh"></i>เริ่มใหม่</button> 
									     <a href="index.php" class="btn btn-success  "><i class="fa fa-arrow-left"></i>ย้อนกลับ</a> 
...
<?php }else { ?>
	...
	<div class="searchagain"> 
		<a href=""><i class="fa fa-arrow-left"></i>ค้นหาอีกครั้ง</a> 
	</div>  
			  ...
			  // 		echo '<tr>';  
				...
				echo '<div class="layer">
						<a href="">
							...
							<div class="desc">เลขครุภัณฑ์ : ' . $result->IBSN.' .. '.  $result->BookDesc.' หมวดหมู่ '.  $result->Category.'<br/>เจ้าของ : '. $result->Author.'</div>
						</a>
					</div>'; 
