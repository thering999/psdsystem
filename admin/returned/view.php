...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">รายละเอียดครุภัณฑ์ที่ถูกยืมไป</h6>
...
<div class="row">
            <div class="col-md-6">  
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3"> 
                          <label class="small mb-1" for="BookDesc">คำอธิบาย</label>  
                     </div> 
                    <div class="col-md-9"> 
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                  <div class="row">
                    <div class="col-md-3"> 
                    <label class="small mb-1" for="DateBorrowed">วันที่ยืม</label>  
                    </div> 
                    <div class="col-md-9"> 
                        <p><?php echo  isset($trans->DateBorrowed) ?$trans->DateBorrowed : 'None'; ?></p> 
                    </div> 
                    <div class="col-md-3"> 
                      <label class="small mb-1" for="DueDate">วันที่กำหนดคืน</label>  
                    </div> 
                    <div class="col-md-9"> 
             ...
             <div class="col-md-6">
               <div class="row"> 
                    <div class="col-md-3"> 
                      <label class="small mb-1" for="DateReturned">วันที่คืน</label>  
                    </div> 
                    <div class="col-md-9"> 
                        <p><?php echo  isset($trans->DateReturned) ?$trans->DateReturned : 'None'; ?></p> 
                    </div>    
                    <div class="col-md-3"> 
                      <label class="small mb-1" for="Remarks">หมายเหตุ</label>  
                    </div> 
                    <div class="col-md-9"> 
