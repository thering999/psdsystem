...
?>
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">รายการผู้ยืมครุภัณฑ์
             <?php if ($_SESSION['TYPE']=="SystemAdministrator" || $_SESSION['TYPE']=="Administrator") { ?>
              	<a href="index.php?view=add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>เพิ่มใหม่</a>
              <?php } ?>
          	</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
							...
							<table id="dataTable" class="table table-bordered  table-hover  " cellspacing="0">
							  ...
							  <thead>
							  	<tr>
							  		<th width="5%">ID ผู้ยืมครุภัณฑ์</th>
							  		 <th>ชื่อ นามสกุล</th>
							  		 <th>ที่อยู่</th>
							  		 <th>เพศ</th> 
