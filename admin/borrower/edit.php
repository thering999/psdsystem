...
// $res = $autonum->single_autonumber(2);
 ...
 <div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">แก้ไขรายละเอียดผู้ยืม</h6>
  </div>
  <div class="card-body"> 
        ...
        <form class="form-horizontal span6  wow fadeInDown" action="controller.php?action=edit" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              "BorrowerId">ID ผู้ยืมครุภัณฑ์</label>
        ...
        <div class="form-group">
          <div class="row">
           ...
           <div class="form-group">
            <div class="row">
              <label class="col-md-2 control-label" for=
              "ContactNo">เบอร์โทรติดต่อ:</label>
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-2 control-label" for=
              "CourseYear">ฝ่าย/หน่วยงาน:</label>
          ...
          <div class="form-group">
            <div class="row"> 
              <div class="col-md-8">
               <button class="btn btn-primary btn-md" name="save" type="submit" ><span class="fa fa-save fw-fa"></span>บันทึก</button>  
               </div>
            </div>
          </div> 
