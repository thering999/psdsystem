...
<html lang="en">
    <head>
        ...
        <title>Admin Panel ระบบยืม-คืนครุภัณฑ์ สสจ.มุกดาหาร</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="<?php echo web_root;?>admin/">ระบบยืม-คืนครุภัณฑ์ </br> สสจ.มุกดาหาร</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button
            ><!-- Navbar Search-->
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="<?php echo web_root;?>admin/users/index.php?view=view&id=<?php echo $_SESSION['USERID']?>">ผู้ใช้งาน</a> 
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?php echo web_root;?>admin/logout.php">ออกจากระบบ</a>
                    </div>
                </li>
            </ul>
        </nav>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            Dashboard </a>
                            <div class="sb-sidenav-menu-heading">ข้อมูลรายการ</div>
                               ...
                               <div class="sb-sidenav-menu-heading">จัดการข้อมูล</div>
                                ...
                                รายการผู้ยืมครุภัณฑ์</a>
                                  <a class="nav-link" href="<?php echo web_root;?>admin/users/">
                                    <div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>
                                จัดการรายชื่อผู้ใช้งาน</a> 
                        </div>
                    </div>
                    <div class="sb-sidenav-footer">
                        <div class="small">Login โดย:</div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Patsadu System 2023</div>
                            <div>
